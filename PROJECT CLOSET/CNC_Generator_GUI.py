...
v1.00 - 2025-12-27: Initial GUI application with all 21 variables from Box 
...
Shadowbox project. Features a single-page interface with all parametric
...
class OutputManager:
    ...
    def __init__(self, base_dir, project_name="Box_Shadowbox"):
...
3. Double-click Launch_Generator.command
   - Or run: python3 CNC_Generator_GUI.py
...
Created by the Shadowbox Project
"""
