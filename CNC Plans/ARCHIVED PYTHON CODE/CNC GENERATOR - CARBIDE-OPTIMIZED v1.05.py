#!/usr/bin/env python3
"""
# CNC GENERATOR - CARBIDE-OPTIMIZED v1.05
# ========================================
# PRODUCTION RELEASE v1.05
#
# Key Changes:
...
def generate_french_cleats(version):
    ...
    r_cs = 0.375 / 2
    for hx, hy in hole_positions:
        cs_elements.append(create_circle(hx, hy, r_cs, COLOR_POCKET)) # Use Pocket Color/Layer
...
class CarbideOptimizedApp(tk.Tk):
    ...
    def setup_ui(self):
        ...
        # Version
        tk.Label(container, text="v1.05", font=FONT_VERSION, bg=BG_COLOR, fg=TEXT_HINT).place(relx=1.0, rely=1.0, anchor="se")
