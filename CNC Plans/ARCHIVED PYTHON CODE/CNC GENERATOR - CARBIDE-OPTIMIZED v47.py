...
class CarbideOptimizedApp(tk.Tk):
    ...
    def setup_ui(self):
        ...
        # Generate button
        gen_btn = tk.Button(right_col, text="GENERATE", command=self.run_generation,
                            font=FONT_BUTTON, bg=ACCENT_COLOR, fg="white",
                            relief=tk.FLAT, padx=40, pady=12, cursor="hand2",
                            activebackground="#3aa8e0", activeforeground="white")
        gen_btn.pack()
