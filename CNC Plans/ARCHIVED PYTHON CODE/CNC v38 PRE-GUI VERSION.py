#!/usr/bin/env python3
"""
Box Parametric CNC Shadowbox Generator v38
=============================================
UPDATES v38:
...
def get_user_inputs():
    print("=" * 60)
    print("Box Parametric CNC Generator v38 - Initialization")
    print("=" * 60)
...
def main():
    get_user_inputs()
    base_path = Path("/Users/joelsilverman/Desktop/2026 Files/26-005 CNC Box Creator/CNC Plans")
    ...
    output_dir = base_path / f"Box SVGs v{next_ver}"
