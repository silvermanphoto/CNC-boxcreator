#!/usr/bin/env python3
"""
# CNC GENERATOR - CARBIDE-OPTIMIZED v1.19
# ========================================
# PRODUCTION RELEASE v1.19
#
# Key Changes:
    ...
    def update_box(self, width_in, height_in, depth_in, stock_thk_in, window_w=0, window_h=0, 
        ...
        if hatch_enabled:
            ...
            poly_h = Poly3DCollection([hatch_verts], alpha=0.9, facecolor='#2c3e50',
                                    edgecolor='#e74c3c', linewidth=1.5) # Red outline
...
def create_shadowbox_assembly():
    ...
    # 5c. CREATE HATCH (Restored v1.13)
    if CONFIG.get('HATCH_ENABLED', 'False') == 'True':
        print("[5c/8] Creating Hatch Lid...")
...
class CarbideOptimizedApp(tk.Tk):
    ...
    def setup_ui(self):
        ...
        tk.Label(container, text="v1.13", font=FONT_VERSION, bg=BG_COLOR, fg=TEXT_HINT).place(relx=1.0, rely=1.0, anchor="se")
            ...
            if CONFIG['HATCH_ENABLED']:
                ...
                def set_mac_label(filepath, color_idx):
                    try:
                        ...
                        cmd = ['osascript', '-e', f'tell application "Finder" to set label index of (POSIX file "{filepath}") to {color_idx}']
