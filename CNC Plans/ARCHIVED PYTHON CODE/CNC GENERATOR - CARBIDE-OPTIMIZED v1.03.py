#!/usr/bin/env python3
"""
# CNC GENERATOR - CARBIDE-OPTIMIZED v1.01
# ========================================
# PRODUCTION RELEASE v1.01
#
# Key Changes:
...
class CarbideOptimizedApp(tk.Tk):
    ...
    def setup_ui(self):
        ...
        # Version
        tk.Label(container, text="v1.01", font=FONT_VERSION, bg=BG_COLOR, fg=TEXT_HINT).place(relx=1.0, rely=1.0, anchor="se")
