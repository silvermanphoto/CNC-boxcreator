#!/usr/bin/env python3
"""
OPEN ME IN BLENDER - Shadowbox Assembly v104
=========================================================
Generated by CNC Generator - Carbide-Optimized v104
...
# ==============================================================================
CONFIG = {
    'TOTAL_WIDTH_IN': 40.0000,
    'TOTAL_HEIGHT_IN': 40.0000,
    'BOX_DEPTH_IN': 4.2500,
    'STOCK_THICKNESS_IN': 0.5984,
    'STOCK_THICKNESS_M': 0.015199,
    'TOTAL_WIDTH_M': 1.016000,
    'TOTAL_HEIGHT_M': 1.016000,
    'BOX_DEPTH_M': 0.107950,
    'WINDOW_WIDTH_M': 0.972901,
    'WINDOW_HEIGHT_M': 0.972901,
    'FRONT_RABBET_WIDTH_M': -0.000200,
    'FRONT_RABBET_DEPTH_M': 0.007600,
    'BACK_RABBET_WIDTH_M': -0.000200,
    'BACK_RABBET_DEPTH_M': 0.007600,
    'BACK_HOLE_RADIUS_M': 0.002540,
    'BACK_RIM_WIDTH_M': 0.015399,
    'FRONT_RIM_WIDTH_M': 0.021549,
    'CLEATS_ENABLED': True,
    'HATCH_ENABLED': False,
...
BACK_PANEL_HOLES = [(0.14223999999999998, 0.33866666666666667), (0.36982400000000004, 0.33866666666666667), (0.638048, 0.33866666666666667), (0.87376, 0.33866666666666667)]
...
# ==============================================================================
SVG_PATHS = {
    'TOP_RAIL': """M 2.0000 2.0000 L 40.8032 2.0000 L 40.8032 2.0000 L 41.3937 2.0000 L 41.3937 2.6032 L 40.8032 2.6032 L 40.8032 2.6071 L 40.8032 3.2143 L 40.8032 3.2182 L 41.3937 3.2182 L 41.3937 3.8175 L 40.8032 3.8175 L 40.8032 3.8214 L 40.8032 4.4286 L 40.8032 4.4325 L 41.3937 4.4325 L 41.3937 5.0318 L 40.8032 5.0318 L 40.8032 5.0357 L 40.8032 5.6429 L 40.8032 5.6468 L 41.3937 5.6468 L 41.3937 6.2500 L 40.8032 6.2500 L 40.8032 6.2500 L 2.0000 6.2500 L 2.0000 6.2500 L 1.4095 6.2500 L 1.4095 5.6468 L 2.0000 5.6468 L 2.0000 5.6429 L 2.0000 5.0357 L 2.0000 5.0318 L 1.4095 5.0318 L 1.4095 4.4325 L 2.0000 4.4325 L 2.0000 4.4286 L 2.0000 3.8214 L 2.0000 3.8175 L 1.4095 3.8175 L 1.4095 3.2182 L 2.0000 3.2182 L 2.0000 3.2143 L 2.0000 2.6071 L 2.0000 2.6032 L 1.4095 2.6032 L 1.4095 2.0000 L 2.0000 2.0000 L 2.0000 2.0000 Z""",
    'BOTTOM_RAIL': """M 2.0000 2.0000 L 40.8032 2.0000 L 40.8032 2.0000 L 41.3937 2.0000 L 41.3937 2.6032 L 40.8032 2.6032 L 40.8032 2.6071 L 40.8032 3.2143 L 40.8032 3.2182 L 41.3937 3.2182 L 41.3937 3.8175 L 40.8032 3.8175 L 40.8032 3.8214 L 40.8032 4.4286 L 40.8032 4.4325 L 41.3937 4.4325 L 41.3937 5.0318 L 40.8032 5.0318 L 40.8032 5.0357 L 40.8032 5.6429 L 40.8032 5.6468 L 41.3937 5.6468 L 41.3937 6.2500 L 40.8032 6.2500 L 40.8032 6.2500 L 2.0000 6.2500 L 2.0000 6.2500 L 1.4095 6.2500 L 1.4095 5.6468 L 2.0000 5.6468 L 2.0000 5.6429 L 2.0000 5.0357 L 2.0000 5.0318 L 1.4095 5.0318 L 1.4095 4.4325 L 2.0000 4.4325 L 2.0000 4.4286 L 2.0000 3.8214 L 2.0000 3.8175 L 1.4095 3.8175 L 1.4095 3.2182 L 2.0000 3.2182 L 2.0000 3.2143 L 2.0000 2.6071 L 2.0000 2.6032 L 1.4095 2.6032 L 1.4095 2.0000 L 2.0000 2.0000 L 2.0000 2.0000 Z""",
    'LEFT_RAIL': """M 2.5984 2.0000 L 41.4016 2.0000 L 41.4016 2.6071 L 42.0000 2.6071 L 42.0000 3.2143 L 42.0000 3.2143 L 41.4016 3.2143 L 41.4016 3.8214 L 42.0000 3.8214 L 42.0000 4.4286 L 42.0000 4.4286 L 41.4016 4.4286 L 41.4016 5.0357 L 42.0000 5.0357 L 42.0000 5.6429 L 42.0000 5.6429 L 41.4016 5.6429 L 41.4016 6.2500 L 2.5984 6.2500 L 2.5984 5.6429 L 2.0000 5.6429 L 2.0000 5.0357 L 2.0000 5.0357 L 2.5984 5.0357 L 2.5984 4.4286 L 2.0000 4.4286 L 2.0000 3.8214 L 2.0000 3.8214 L 2.5984 3.8214 L 2.5984 3.2143 L 2.0000 3.2143 L 2.0000 2.6071 L 2.0000 2.6071 L 2.5984 2.6071 L 2.5984 2.0000 Z""",
    'RIGHT_RAIL': """M 2.5984 2.0000 L 41.4016 2.0000 L 41.4016 2.6071 L 42.0000 2.6071 L 42.0000 3.2143 L 42.0000 3.2143 L 41.4016 3.2143 L 41.4016 3.8214 L 42.0000 3.8214 L 42.0000 4.4286 L 42.0000 4.4286 L 41.4016 4.4286 L 41.4016 5.0357 L 42.0000 5.0357 L 42.0000 5.6429 L 42.0000 5.6429 L 41.4016 5.6429 L 41.4016 6.2500 L 2.5984 6.2500 L 2.5984 5.6429 L 2.0000 5.6429 L 2.0000 5.0357 L 2.0000 5.0357 L 2.5984 5.0357 L 2.5984 4.4286 L 2.0000 4.4286 L 2.0000 3.8214 L 2.0000 3.8214 L 2.5984 3.8214 L 2.5984 3.2143 L 2.0000 3.2143 L 2.0000 2.6071 L 2.0000 2.6071 L 2.5984 2.6071 L 2.5984 2.0000 Z""",
}
...
def create_shadowbox_assembly():
    ...
    print("=" * 60)
    print("Creating Shadowbox Assembly v104")
