#!/usr/bin/env python3
"""
OPEN ME IN TRIVISION - Shadowbox Assembly v125_HEADLESS
===========================================================
Generated by CNC Generator - Carbide-Optimized v125_HEADLESS
...
# ==============================================================================
CONFIG = {
    'TOTAL_WIDTH_IN': 63.5968,
    'TOTAL_HEIGHT_IN': 46.1968,
    'BOX_DEPTH_IN': 5.0984,
    'STOCK_THICKNESS_IN': 0.5984,
    'STOCK_THICKNESS_M': 0.015200,
    'TOTAL_WIDTH_M': 1.615359,
    'TOTAL_HEIGHT_M': 1.173399,
    'BOX_DEPTH_M': 0.129499,
    'WINDOW_WIDTH_M': 1.356360,
    'WINDOW_HEIGHT_M': 0.914400,
    'FRONT_RABBET_WIDTH_M': 0.007620,
    'FRONT_RABBET_DEPTH_M': 0.007620,
    'BACK_RABBET_WIDTH_M': 0.007620,
    'BACK_RABBET_DEPTH_M': 0.007620,
    'BACK_HOLE_RADIUS_M': 0.002540,
    'BACK_RIM_WIDTH_M': 0.007580,
    'FRONT_RIM_WIDTH_M': 0.129499,
}

# Back panel hole positions (in meters)
BACK_PANEL_HOLES = [(0.25903936, 0.3911329066666666), (0.60041536, 0.3911329066666666), (1.00275136, 0.3911329066666666), (1.3563193599999999, 0.3911329066666666)]
...
# ==============================================================================
SVG_PATHS = {
    'TOP_RAIL': """M 2.0000 2.0000 L 64.3999 2.0000 L 64.3999 2.0000 L 64.9905 2.0000 L 64.9905 2.5626 L 64.3999 2.5626 L 64.3999 2.5665 L 64.3999 3.1330 L 64.3999 3.1369 L 64.9905 3.1369 L 64.9905 3.6955 L 64.3999 3.6955 L 64.3999 3.6995 L 64.3999 4.2660 L 64.3999 4.2699 L 64.9905 4.2699 L 64.9905 4.8285 L 64.3999 4.8285 L 64.3999 4.8324 L 64.3999 5.3989 L 64.3999 5.4029 L 64.9905 5.4029 L 64.9905 5.9615 L 64.3999 5.9615 L 64.3999 5.9654 L 64.3999 6.5319 L 64.3999 6.5358 L 64.9905 6.5358 L 64.9905 7.0984 L 64.3999 7.0984 L 64.3999 7.0984 L 2.0000 7.0984 L 2.0000 7.0984 L 1.4094 7.0984 L 1.4094 6.5358 L 2.0000 6.5358 L 2.0000 6.5319 L 2.0000 5.9654 L 2.0000 5.9615 L 1.4094 5.9615 L 1.4094 5.4029 L 2.0000 5.4029 L 2.0000 5.3989 L 2.0000 4.8324 L 2.0000 4.8285 L 1.4094 4.8285 L 1.4094 4.2699 L 2.0000 4.2699 L 2.0000 4.2660 L 2.0000 3.6995 L 2.0000 3.6955 L 1.4094 3.6955 L 1.4094 3.1369 L 2.0000 3.1369 L 2.0000 3.1330 L 2.0000 2.5665 L 2.0000 2.5626 L 1.4094 2.5626 L 1.4094 2.0000 L 2.0000 2.0000 L 2.0000 2.0000 Z""",
    'BOTTOM_RAIL': """M 2.0000 2.0000 L 64.3999 2.0000 L 64.3999 2.0000 L 64.9905 2.0000 L 64.9905 2.5626 L 64.3999 2.5626 L 64.3999 2.5665 L 64.3999 3.1330 L 64.3999 3.1369 L 64.9905 3.1369 L 64.9905 3.6955 L 64.3999 3.6955 L 64.3999 3.6995 L 64.3999 4.2660 L 64.3999 4.2699 L 64.9905 4.2699 L 64.9905 4.8285 L 64.3999 4.8285 L 64.3999 4.8324 L 64.3999 5.3989 L 64.3999 5.4029 L 64.9905 5.4029 L 64.9905 5.9615 L 64.3999 5.9615 L 64.3999 5.9654 L 64.3999 6.5319 L 64.3999 6.5358 L 64.9905 6.5358 L 64.9905 7.0984 L 64.3999 7.0984 L 64.3999 7.0984 L 2.0000 7.0984 L 2.0000 7.0984 L 1.4094 7.0984 L 1.4094 6.5358 L 2.0000 6.5358 L 2.0000 6.5319 L 2.0000 5.9654 L 2.0000 5.9615 L 1.4094 5.9615 L 1.4094 5.4029 L 2.0000 5.4029 L 2.0000 5.3989 L 2.0000 4.8324 L 2.0000 4.8285 L 1.4094 4.8285 L 1.4094 4.2699 L 2.0000 4.2699 L 2.0000 4.2660 L 2.0000 3.6995 L 2.0000 3.6955 L 1.4094 3.6955 L 1.4094 3.1369 L 2.0000 3.1369 L 2.0000 3.1330 L 2.0000 2.5665 L 2.0000 2.5626 L 1.4094 2.5626 L 1.4094 2.0000 L 2.0000 2.0000 L 2.0000 2.0000 Z""",
    'LEFT_RAIL': """M 2.5984 2.0000 L 47.5984 2.0000 L 47.5984 2.5665 L 48.1968 2.5665 L 48.1968 3.1330 L 48.1968 3.1330 L 47.5984 3.1330 L 47.5984 3.6995 L 48.1968 3.6995 L 48.1968 4.2660 L 48.1968 4.2660 L 47.5984 4.2660 L 47.5984 4.8324 L 48.1968 4.8324 L 48.1968 5.3989 L 48.1968 5.3989 L 47.5984 5.3989 L 47.5984 5.9654 L 48.1968 5.9654 L 48.1968 6.5319 L 48.1968 6.5319 L 47.5984 6.5319 L 47.5984 7.0984 L 2.5984 7.0984 L 2.5984 6.5319 L 2.0000 6.5319 L 2.0000 5.9654 L 2.0000 5.9654 L 2.5984 5.9654 L 2.5984 5.3989 L 2.0000 5.3989 L 2.0000 4.8324 L 2.0000 4.8324 L 2.5984 4.8324 L 2.5984 4.2660 L 2.0000 4.2660 L 2.0000 3.6995 L 2.0000 3.6995 L 2.5984 3.6995 L 2.5984 3.1330 L 2.0000 3.1330 L 2.0000 2.5665 L 2.0000 2.5665 L 2.5984 2.5665 L 2.5984 2.0000 Z""",
    'RIGHT_RAIL': """M 2.5984 2.0000 L 47.5984 2.0000 L 47.5984 2.5665 L 48.1968 2.5665 L 48.1968 3.1330 L 48.1968 3.1330 L 47.5984 3.1330 L 47.5984 3.6995 L 48.1968 3.6995 L 48.1968 4.2660 L 48.1968 4.2660 L 47.5984 4.2660 L 47.5984 4.8324 L 48.1968 4.8324 L 48.1968 5.3989 L 48.1968 5.3989 L 47.5984 5.3989 L 47.5984 5.9654 L 48.1968 5.9654 L 48.1968 6.5319 L 48.1968 6.5319 L 47.5984 6.5319 L 47.5984 7.0984 L 2.5984 7.0984 L 2.5984 6.5319 L 2.0000 6.5319 L 2.0000 5.9654 L 2.0000 5.9654 L 2.5984 5.9654 L 2.5984 5.3989 L 2.0000 5.3989 L 2.0000 4.8324 L 2.0000 4.8324 L 2.5984 4.8324 L 2.5984 4.2660 L 2.0000 4.2660 L 2.0000 3.6995 L 2.0000 3.6995 L 2.5984 3.6995 L 2.5984 3.1330 L 2.0000 3.1330 L 2.0000 2.5665 L 2.0000 2.5665 L 2.5984 2.5665 L 2.5984 2.0000 Z""",
}
...
def create_shadowbox_assembly():
    ...
    print("Collection: OUTSIDE_FRAME_NEW")
    print("=" * 60)

    # Create collection "OUTSIDE_FRAME_NEW" (no scene lighting/unit changes)
    collection_name = "OUTSIDE_FRAME_NEW"
