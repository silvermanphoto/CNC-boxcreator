...
def run_test():
    ...
    # Set Output
    target_dir = os.path.abspath("/Users/joelsilverman/Desktop/2026 Files/26-005 Gemini-created CNC Box Creator/Gemini McTell CNC Plans")
