...
## McTell Shadowbox v66 - Fusion 360 3D Assembly
...
- **Moved Items**:
  ...
  - `Gemini McTell CNC Plans/Generator.iconset`
  - `Gemini McTell CNC Plans/dist` (Contains The Built App)
  - `Gemini McTell CNC Plans/build`
  - `Gemini McTell CNC Plans/Rabbet Visualization from Blender`
  - `Gemini McTell CNC Plans/build_app.sh`
  - `Gemini McTell CNC Plans/*.spec`
  - `Gemini McTell CNC Plans/*.icns`
  - `Gemini McTell CNC Plans/*.icns`
  ...
  - `verify_v50.py`
  - `McTell_Ghostphone_Shadowbox.svg`
